...
import 'education_lesson_note_dialog_model.dart';
export 'education_lesson_note_dialog_model.dart';

class EducationLessonNoteDialogWidget extends StatefulWidget {
  const EducationLessonNoteDialogWidget({
    super.key,
  ...
  @override
  State<EducationLessonNoteDialogWidget> createState() =>
      _EducationLessonNoteDialogWidgetState();
}

class _EducationLessonNoteDialogWidgetState
    extends State<EducationLessonNoteDialogWidget> {
  late EducationLessonNoteDialogModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EducationLessonNoteDialogModel());
        ...
        if (responsiveVisibility(
          ...
          Expanded(
            child: InkWell(
              ...
              onTap: () async {
                logFirebaseEvent('EDUCATION_LESSON_NOTE_DIALOG_Column_oqj0');
        ...
        if (responsiveVisibility(
          ...
          Expanded(
            child: InkWell(
              ...
              highlightColor: Colors.transparent,
              onTap: () async {
                logFirebaseEvent('EDUCATION_LESSON_NOTE_DIALOG_Column_p5ig');
                logFirebaseEvent('Column_bottom_sheet');
                Navigator.pop(context);
              },
              child: Column(
                ...
                children: [
                  Padding(
                    ...
                    child: InkWell(
                      ...
                      onTap: () async {
                        logFirebaseEvent(
                            'EDUCATION_LESSON_NOTE_DIALOG_Container_7');
